...
const Displayemployee= ()=> {
  ...
  return (
    <div>
      ...
      <h2><Link to="/auth/add"  className="text-secondary" ><i class="bi bi-people-fill"></i></Link></h2>
       <div className="bg-white mt-3">
        
        <table className="table table-bordered">
        <thead>
            <tr>
            <th scope="col" className='text-center'>Nom d'employee </th>  
            <th scope="col" className='text-center'>email</th>  
            <th scope="col" className='text-center'>organisme</th>  
